...
public class AnDriver {public static void main(String[] args) throws Exception {
    ...
    job.setJarByClass(AnDriver.class); // Classe de lancement.
    job.setJobName("Anagramme"); // Nom du job.
