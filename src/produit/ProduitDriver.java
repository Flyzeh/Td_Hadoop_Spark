...
public class ProduitDriver {

    public static void main(String[] args) throws Exception {

        // Vérification de la présence des 2 arguments de la fonction.
        if (args.length != 2) {
            System.out.printf("Format de la ligne de commande ProduitDriver <rep source> <rep cible>\n");
            System.exit(-1);
        }

        // Instanciation et initialisation du job Hadoop.
        Job job = Job.getInstance();
        job.setJarByClass(ProduitDriver.class); // Classe de lancement.
        job.setJobName("Produit"); // Nom du job.
